    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          // allow tap-to-close on overlay itself
        }}
      >
        {/* Card */}
        <div
        ...
        >
          ...
          <div style={{ padding: "18px 20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 10, color: "var(--text-muted)", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.06em", fontWeight: 700 }}>
                Informasi Lead
              </div>
              {[
                ...
                <div key={r.l} style={{ display: "flex", gap: 8, marginTop: 6, flexWrap: "wrap" }}>
                  ...
                  <span style={{ fontSize: 12, color: "var(--text-primary)", fontWeight: 500, flex: 1, minWidth: 0, wordBreak: "break-word" }}>
                    {r.v}
                  </span>
                </div>
              ))}
            ...
            <div style={{
              ...
              background: "var(--bg-card2)", borderRadius: 10, border: "1px solid var(--border)",
              flexWrap: "wrap",
            }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10, flexWrap: "wrap", marginBottom: 10 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 4, lineHeight: 1.55, wordBreak: "break-word" }}>
                    {lead.calculation.explanation}
                  </div>
                </div>
                <div style={{ fontSize: 22, fontWeight: 900, color, flexShrink: 0 }}>
                  {lead.probability}%
                </div>
              </div>
              {/* Progress bar */}
              <div style={{ height: 6, background: "var(--bg-card)", borderRadius: 999, overflow: "hidden" }}>
                <div style={{
                  ...
                  width: `${lead.probability}%`, background: color,
            ...
            <div style={{
              ...
              borderRadius: 12, border: "1px solid var(--primary-glow)",
            }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: "var(--primary)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 6 }}>
                Weighted Forecast Value
              </div>
              <div style={{ fontSize: 22, fontWeight: 900, color: "var(--primary)", wordBreak: "break-all" }}>
    ...
    <>
      <style>{`
        ...
        @media (max-width: 900px) {
          .fc-kpi-grid { grid-template-columns: repeat(2,1fr) !important; }
        }
        @media (max-width: 480px) {
          .fc-kpi-grid { grid-template-columns: 1fr !important; }
          .fc-filter-bar { flex-direction: column !important; }
        }
      `}</style>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
          ...
          <div style={{ position:"relative", zIndex:1 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:12, marginBottom:16 }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                ...
                <button onClick={fetchForecast} style={{ padding:"4px 10px", background:"rgba(75,158,243,0.2)", border:"1px solid rgba(75,158,243,0.3)", borderRadius:6, color:"#93c5fd", fontSize:11, cursor:"pointer" }}>
                  Refresh
                </button>
              </div>
            </div>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <AreaChart data={monthlyHistory} margin={{ top:4, right:4, left:10, bottom:0 }}>
              ...
              <Tooltip
                ...
                formatter={(value) => [formatRp(Number(value ?? 0)), "Revenue"]}
              />
        ...
        <div style={{ background:"var(--bg-card)", borderRadius:16, border:"1px solid var(--border)", overflow:"hidden", boxShadow:"var(--shadow-xs)" }}>
          ...
          <div style={{ padding:"16px 20px", borderBottom:"1px solid var(--border)", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:10 }}>
            ...
            {/* Status filter chips — scrollable pada mobile */}
                  ...
                  return (
                    ...
                    >
                      <td style={{ padding:"11px 14px" }}>
                        <div style={{ fontSize:13, fontWeight:600, color:"var(--text-primary)", maxWidth:180, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                          {lead.title}
                        </div>
                      </td>
                      <td style={{ padding:"11px 14px" }}>
