...
// PENTING: DEMO_ACCOUNTS adalah Record<UATRole, {email, password}> — bukan array
import { DEMO_ACCOUNTS, ROLE_COLOR, ROLE_LABEL, type UATRole } from "@/lib/uat/uatSteps"
...
// Urutan role untuk tampilan list
const UAT_ROLES: UATRole[] = ["SUPER_ADMIN", "EXECUTIVE", "SALES_MANAGER", "ACCOUNT_EXECUTIVE"]

export default function LoginPage() {
  const router                      = useRouter()
  const { isDark, toggle, mounted } = useTheme()

  // useUAT dari uatContext — API sesuai uatContext.tsx: { start, active, role }
  ...
  // ── UAT start handler ──────────────────────────────────────
  // FIX UTAMA: DEMO_ACCOUNTS adalah Record<UATRole, {email, password}>
  // Akses langsung dengan DEMO_ACCOUNTS[role] — bukan .find()
  function handleStartUAT(role: UATRole) {
    const account = DEMO_ACCOUNTS[role]  // ← Record access langsung, pasti ada
    setEmail(account.email)              // ← isi form email
    setPassword(account.password)        // ← "Test1234!" dari uatSteps
    startUAT(role)                       // ← aktifkan UAT session di context
  }
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 999, color: isDark ? "#8ba3bf" : "#3d5166",
      ...
      <div style={{
        ...
        margin: "auto", padding: "24px", gap: 48,
        ...
        <div className="hide-mobile" style={{
          ...
          <div>
            ...
            <h1 style={{ fontSize: 38, fontWeight: 800, color: isDark ? "#e8f0f8" : "#0d1f2d", lineHeight: 1.2, letterSpacing: "-0.03em", marginBottom: 16 }}>
              Kelola Pipeline<br />
            ...
            <p style={{ fontSize: 14, color: isDark ? "#4d6680" : "#64748b", lineHeight: 1.75, maxWidth: 400 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {[
              ...
              "Manajemen tim dengan 4 level role akses",
            ].map((f) => (
              <div key={f} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontSize: 13, color: isDark ? "#8ba3bf" : "#3d5166" }}>{f}</span>
              </div>
            ))}
          </div>
        ...
        <div style={{ width: "100%", maxWidth: 420, flexShrink: 0, animation: "slideInUp 0.5s ease 0.1s both" }}>
          <div style={{
            ...
            boxShadow:      isDark ? "0 24px 64px rgba(0,0,0,0.6)" : "0 24px 64px rgba(13,31,45,0.1)",
          }}>
            ...
            <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              {/* Email field */}
              <div>
                <label style={{ display: "block", fontSize: 11, fontWeight: 700, color: isDark ? "#4d6680" : "#64748b", marginBottom: 8, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                  Alamat Email
                </label>
                <div style={{ position: "relative" }}>
                  <div style={{ position: "absolute", left: 13, top: "50%", transform: "translateY(-50%)", color: isDark ? "#2e4560" : "#94a3b8", pointerEvents: "none", display: "flex", alignItems: "center" }}>
                    <IconMail />
                  </div>
                  <input
                    type="email" required
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      letterSpacing: showPw ? "normal" : "0.08em", outline: "none",
                    }}
                  />
                  <button
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: status === "success" ? "0 4px 18px rgba(5,150,105,0.4)" : "0 4px 18px rgba(59,130,246,0.4)",
                  transition: "all 0.3s",
                }}
                onMouseEnter={(e) => {
              ...
              >
                {status === "loading" ? (
                  ...
                  <>Masuk ke Dashboard <IconChevron /></>
                )}
              </button>
            </form>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                {UAT_ROLES.map((r) => {
                  const account = DEMO_ACCOUNTS[r]      // ← Record access
                  ...
                  return (
                    ...
                    >
                      <span style={{ fontSize: 11, color: isDark ? "#8ba3bf" : "#3d5166", fontFamily: "monospace" }}>
                        {account.email}
                      </span>
                      <span style={{ fontSize: 9, fontWeight: 700, padding: "2px 7px", borderRadius: 999, background: color + "18", color }}>
                        {label}
                      </span>
                    </button>
                  )
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                {UAT_ROLES.map((r) => {
                  ...
                  const account    = DEMO_ACCOUNTS[r]   // ← Record access langsung
                  ...
                  return (
                    ...
                    >
                      <div style={{ textAlign: "left" }}>
                        ...
                        <div style={{ fontSize: 10, color: isDark ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.4)", fontFamily: "monospace" }}>
                          {account.email}
                        </div>
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                        ...
                        <div style={{ fontSize: 10, color: c, display: "flex", alignItems: "center", gap: 3 }}>
                          Mulai UAT
